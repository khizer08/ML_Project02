...
import type { LinearRegressionInput, LinearRegressionOutput, LogisticRegressionInput, LogisticRegressionOutput } from "@shared/schema";
...
export default function MLModels() {
  ...
  const linearMutation = useMutation<LinearRegressionOutput, Error, LinearRegressionInput>({
    mutationFn: async (data) => {
      const response = await apiRequest("POST", "/api/ml/linear-regression", data);
      return response as LinearRegressionOutput;
    },
    onSuccess: () => {
      toast({
  ...
  const logisticMutation = useMutation<LogisticRegressionOutput, Error, LogisticRegressionInput>({
    mutationFn: async (data) => {
      const response = await apiRequest("POST", "/api/ml/logistic-regression", data);
      return response as LogisticRegressionOutput;
    },
    onSuccess: () => {
      toast({
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLinearInput({ ...linearInput, humidity: parseFloat(e.target.value) })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLinearInput({ ...linearInput, pressure: parseFloat(e.target.value) })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLinearInput({ ...linearInput, wind_speed: parseFloat(e.target.value) })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLinearInput({ ...linearInput, clouds: parseFloat(e.target.value) })}
              ...
              {linearMutation.data && (
                <div className="space-y-4 p-6 bg-primary/5 rounded-lg border border-primary/20 animate-fade-in">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-5xl font-display font-bold text-primary" data-testid="text-predicted-temp">
            ...
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <CardDescription>Classify weather conditions (Rain/Clear, Cloudy/Clear)</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLogisticInput({ ...logisticInput, temperature: parseFloat(e.target.value) })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLogisticInput({ ...logisticInput, humidity: parseFloat(e.target.value) })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLogisticInput({ ...logisticInput, pressure: parseFloat(e.target.value) })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLogisticInput({ ...logisticInput, wind_speed: parseFloat(e.target.value) })}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setLogisticInput({ ...logisticInput, clouds: parseFloat(e.target.value) })}
                ...
                <div className="space-y-4 p-6 bg-chart-3/10 rounded-lg border border-chart-3/20 animate-fade-in">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center space-y-2 p-4 bg-background rounded-lg">
                      ...
                      <Badge 
                        variant={logisticMutation.data.rain_prediction === "Rain" ? "default" : "secondary"}
                      ...
                      <p className="text-xs text-muted-foreground">
                        {(logisticMutation.data.rain_probability * 100).toFixed(1)}% confidence
                      </p>
                    </div>
                    ...
                    <div className="text-center space-y-2 p-4 bg-background rounded-lg">
                      ...
                      <Badge 
                        variant={logisticMutation.data.cloudiness_prediction === "Cloudy" ? "default" : "secondary"}
                        className="text-lg px-4 py-2"
                      ...
                      <p className="text-xs text-muted-foreground">
                        {(logisticMutation.data.cloudiness_probability * 100).toFixed(1)}% confidence
                      </p>
                    </div>
                  </div>
